...
class BefungeLogicInterpreter {
  ...
  static FEATURES = ['movement', 'logic-gates', 'stack', 'memory', 'pixels', 'subroutines', 'loops', 'for-loops', 'text', 'ascii-output', 'packing', 'exponents', 'elbow-redirect'];
...
if (typeof window !== 'undefined') {
  window.BefungeLogicInterpreter = BefungeLogicInterpreter;
  window.runLogifunge = function(source) { return new BefungeLogicInterpreter(source).run().textOutput; };
}